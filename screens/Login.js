                ...
                <Block row space='evenly' style={{width: '90%'}}>
                  <Block flex left>
                    <Button 
                      ...
                      style={{width: 'auto', paddingHorizontal: 20}}
                      color={'rgb(0, 177, 238)'} 
                      onPress={() => setFieldTouched('email') && setFieldTouched('password') && validateForm().then(res => {if (touched.email && touched.password && errors.password === undefined && errors.email === undefined) {Keyboard.dismiss(); submitLogin(values);}})} 
                      icon='unlock'
